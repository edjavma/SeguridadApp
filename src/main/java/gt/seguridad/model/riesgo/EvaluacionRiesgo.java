...
@NamedNativeQueries({
	@NamedNativeQuery(name = "EvaluacionRiesgo.getInfoDashboardRiesgo",
			query = "SELECT TIPO, TOTAL, PORCENTAJE, PKG_DASHBOARD.NIVEL_MAX_RIESGO(ID_TIPO_RIESGO, ?1) NIVEL_RIESGO, "+
					"PKG_DASHBOARD.OBTENER_NIVEL_RIESGO(4, ID_TIPO_RIESGO, ?1) TOTAL_CRITICO, " + 
					"PKG_DASHBOARD.OBTENER_NIVEL_RIESGO(3, ID_TIPO_RIESGO, ?1) TOTAL_ALTO, " + 
					"PKG_DASHBOARD.OBTENER_NIVEL_RIESGO(2, ID_TIPO_RIESGO, ?1) TOTAL_MEDIO, " + 
					"PKG_DASHBOARD.OBTENER_NIVEL_RIESGO(1, ID_TIPO_RIESGO, ?1) TOTAL_BAJO FROM ( " + 
					...
					"INNER JOIN TIPO_DE_RIESGO T ON R.ID_TIPO_RIESGO = T.ID_TIPO_RIESGO " + 
					"WHERE E.APLICA = 1 "+
					"AND E.ID_ARQUITECTURA = NVL(?1, E.ID_ARQUITECTURA) "+
	...
	@NamedNativeQuery(name = "EvaluacionRiesgo.getInfoDashboardImpacto",
			query = "SELECT TIPO, TOTAL, PORCENTAJE,    " + 
					"PKG_DASHBOARD.NIVEL_MAX_IMPACTO(ID_TIPO_IMPACTO, ?1) NIVEL_RIESGO,   " + 
					"PKG_DASHBOARD.OBTENER_NIVEL_IMPACTO(4, ID_TIPO_IMPACTO, ?1) TOTAL_CRITICO,   " + 
					"PKG_DASHBOARD.OBTENER_NIVEL_IMPACTO(3, ID_TIPO_IMPACTO, ?1) TOTAL_ALTO,   " + 
					"PKG_DASHBOARD.OBTENER_NIVEL_IMPACTO(2, ID_TIPO_IMPACTO, ?1) TOTAL_MEDIO,   " + 
					"PKG_DASHBOARD.OBTENER_NIVEL_IMPACTO(1, ID_TIPO_IMPACTO, ?1) TOTAL_BAJO FROM (   " + 
	...
	@NamedNativeQuery(name = "EvaluacionRiesgo.getInfoDashboardBrecha",
				query = "SELECT TIPO, TOTAL, PORCENTAJE,     " + 
						"PKG_DASHBOARD.NIVEL_MAX_BRECHA(ID_TIPO_BRECHA, ?1) NIVEL_RIESGO,    " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_BRECHA(4, ID_TIPO_BRECHA, ?1) TOTAL_CRITICO,    " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_BRECHA(3, ID_TIPO_BRECHA, ?1) TOTAL_ALTO,    " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_BRECHA(2, ID_TIPO_BRECHA, ?1) TOTAL_MEDIO,    " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_BRECHA(1, ID_TIPO_BRECHA, ?1) TOTAL_BAJO FROM (    " + 
	...
	@NamedNativeQuery(name = "EvaluacionRiesgo.getInfoDashboardTratamiento",
				query = "SELECT TIPO, TOTAL, PORCENTAJE,    " + 
						"PKG_DASHBOARD.NIVEL_MAX_TRATAMIENTO(ID_TIPO_TRATAMIENTO, ?1) NIVEL_RIESGO,   " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_TRATAMIENTO(4, ID_TIPO_TRATAMIENTO, ?1) TOTAL_CRITICO,   " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_TRATAMIENTO(3, ID_TIPO_TRATAMIENTO, ?1) TOTAL_ALTO,   " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_TRATAMIENTO(2, ID_TIPO_TRATAMIENTO, ?1) TOTAL_MEDIO,   " + 
						"PKG_DASHBOARD.OBTENER_NIVEL_TRATAMIENTO(1, ID_TIPO_TRATAMIENTO, ?1) TOTAL_BAJO FROM (   " + 
